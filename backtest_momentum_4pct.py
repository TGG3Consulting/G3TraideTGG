...
print()
print("=" * 80)
print("MOMENTUM: 0% vs 3% vs 4% vs 5% (BTC + XRP)")
print("=" * 80)
print()
print(f"{'Threshold':<10} {'Trades':>7} {'Win%':>7} {'PnL':>12} {'MaxDD':>10} | {'2M Tr':>5} {'2M Win%':>7} {'2M PnL':>10}")
print("-" * 80)
...
for threshold in [0, 3, 4, 5]:
    ...
    print(f"{threshold}%{'':<8} {c['trades']:>7} {win_pct:>6.1f}% ${c['pnl']:>+10,.0f} ${c['max_dd']:>9,.0f} | {c['trades_2m']:>5} {win_2m:>6.1f}% ${c['pnl_2m']:>+9,.0f}")
