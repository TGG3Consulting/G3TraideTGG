...
# Load SOL Excel
excel_path = r'G:\TradeAI1\TimeLagTester\SOLUSDT_volatility_2y.xlsx'
df = pd.read_excel(excel_path)

print(f"Loaded SOL: {len(df)} rows")
...
print("Downloading L/S data for SOLUSDT...")
...
output_path = r'G:\BinanceFriend\SOLUSDT_volatility_2y_with_LS.xlsx'
